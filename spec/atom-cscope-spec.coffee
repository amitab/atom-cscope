...
describe "AtomCscope", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('atom-cscope')

  describe "when the atom-cscope:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'atom-cscope:toggle'
        expect(atomCscopePanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'atom-cscope:toggle'
        expect(atomCscopeElement).not.toBeVisible()
